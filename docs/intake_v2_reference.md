...
cat.to_yaml_file("ocean_skill/catalogs/woa.yaml")

# consumer side
cat = intake.from_yaml_file("ocean_skill/catalogs/woa.yaml")
...
`ocean_skill/catalogs/woa.yaml` (WOA23 nitrate/phosphate/silicate/oxygen, annual
